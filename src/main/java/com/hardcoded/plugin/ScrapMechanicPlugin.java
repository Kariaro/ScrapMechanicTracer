...
import com.hardcoded.plugin.tracer.*;
...
public class ScrapMechanicPlugin extends ProgramPlugin implements FrontEndable {
	...
	public final ImageIcon icon_64 = ResourceManager.loadImage("images/smt_icon_64.png");
	public final ImageIcon icon_16 = ResourceManager.loadImage("images/smt_icon_16.png");
	...
	public ScrapMechanicPlugin(PluginTool tool) {
		...
		Logger.log("If this message is shown the tool was started in developer mode");
