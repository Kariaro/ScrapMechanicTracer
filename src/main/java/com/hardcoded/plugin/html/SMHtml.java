package com.hardcoded.plugin.html;
...
public class SMHtml {
	...
	private SMHtml(Preferences prefs, String version, SMClass table) {
		this.prefs = prefs;
	...
	public static void generate(Preferences prefs, String version, SMClass clazz) {
