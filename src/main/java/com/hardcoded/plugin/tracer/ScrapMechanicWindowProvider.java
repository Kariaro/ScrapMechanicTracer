...
import com.hardcoded.plugin.Preferences;
import com.hardcoded.plugin.ScrapMechanicPlugin;
import com.hardcoded.plugin.exporter.JsonExporter;
import com.hardcoded.plugin.exporter.SmmJsonExporter;
import com.hardcoded.plugin.html.SMHtml;
import com.hardcoded.plugin.json.JsonMap;
...
public class ScrapMechanicWindowProvider extends ComponentProviderAdapter {
	// TODO: Separate functions from this class into other utility classes
	
	/**
	 * Returns the default plugin home directory
	 */
	public static final String getDefaultSavePath() {
		File tracePath = new File(Preferences.getSavePath(), "traces");
	...
	public ScrapMechanicWindowProvider(ScrapMechanicPlugin tool) {
